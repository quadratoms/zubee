a = "%3csvg xmlns=%27http://www.w3.org/2000/svg%27 fill=%27red%27 viewBox=%270 0 16 16%27%3e%3cpath fill=%27none%27 stroke=%27%23343a40%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27 stroke-width=%272%27 d=%27m2 5 6 6 6-6%27/%3e%3c/svg%3e"
print(a.replace("%27", '"').replace("%3c", "<").replace("%3e", ">"))

b = '<svg fill="red" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">\
  <defs></defs>\
  <rect width="16" height="16" style="stroke-opacity: 0.93; fill: rgb(48, 50, 102);"></rect>\
  <path d="m2 5 6 6 6-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke="white" style=""></path>\
</svg>'

print(b.replace('"', "%27").replace("<", "%3c").replace(">", "%3e"))
...
b = ""
for i in a:
    b+="<Picker.Item label=\""+i["name"]+"\" value=\""+i["bank_code"]+"\" />\n"
