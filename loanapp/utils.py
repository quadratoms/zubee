...
def chargecard():
    v = rave.Card(
        FLUTTERWAVE_PUBLIC_KEY, FLUTTERWAVE_SECRET_KEY, production=False, usingEnv=False
    )
...
def bvn():
    r = requests.get(
        "https://api.flutterwave.com/v3/kyc/bvns/22367715797",
        headers={"Authorization": "Bearer FLWSECK-2a552f68bf49ea88fc33ea8f8920885d-X"},
    )
